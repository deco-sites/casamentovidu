            ...
            <div className="bg-[#f8f5f0] py-8 flex flex-col items-center">
                ...
                <div className="flex flex-row gap-4">
                    <a 
                        ...
                        className="px-6 py-3 bg-[#80965F] text-white font-medium rounded-md hover:bg-[#3e6b00] transition-colors"
                    >
                        Confirmar Presença
                    </a>
                    <a 
                        href="/escolher-presente" 
                        className="px-6 py-3 bg-[#F9F1E3] text-[#80965F] font-medium rounded-md border border-[#FFE6B9] hover:bg-[#3e6b00] transition-colors"
                    >
                        Escolher Presente
                    </a>
                </div>
